...
export default function AdminPage({}: AdminPageProps) {
  ...
  useEffect(() => {
    ...
    // User is admin, fetch posts
    fetchAllPosts()
  }, [userType, authLoading, router, user])
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          <div className="w-16 h-16 border-4 border-[#00d8e8] border-t-transparent rounded-full animate-spin mx-auto mb-4"></div>
          <p className="text-[#1e3a4b] font-semibold">Loading admin panel...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              <h1 className="text-3xl font-bold text-[#1e3a4b]">Blog Administration</h1>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
            <div className="flex items-center">
              ...
              <p className="text-sm text-blue-800">
                <strong>Debug Info:</strong> Showing {blogPosts.length} posts
              </p>
            </div>
          </div>
        )}
